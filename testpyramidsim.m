function [rpupil, Rwavefront, phase]=pyramidsimtest(lambda, error, fbs, rmatrix, kpupil, kscreen, rdns, npix, Npix, pyramidmask, sampling, tripyramid, MVM, broke)
...
FTpupil=fftshift(fft2(fftshift(kpupil)))/Npix;
